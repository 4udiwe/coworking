...
type rawBookingPlaceStatus struct {
	...
	CoworkingCreatedAt time.Time  `db:"coworking_created_at"`
	CoworkingUpdatedAt time.Time  `db:"coworking_updated_at"`
	...
	return entity.Booking{
		...
		Place: entity.Place{
			...
			Coworking: entity.Coworking{
				...
				CreatedAt: r.CoworkingCreatedAt,
				UpdatedAt: r.CoworkingUpdatedAt,
			},
		},
